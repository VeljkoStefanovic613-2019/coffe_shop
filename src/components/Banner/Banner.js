        ...
        <div className="container min-h-[550px] flex justify-center items-center py-12 sm:py-0">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div className="flex flex-col justify-center gap-6 sm:pt-o">
                    ...
                    <p className="text-sm text-gray-500 tracking-wide leading-5 ">Lorem ipsum dolor sit amet consectetur adipisicing elit. Assumenda, fugit. Aperiam iusto ab nihil, neque temporibus id nam tempora.</p>
